...
import SidebarStudentInfo from "../Student's/SidebarStudentInfo";
...
const StudentInfo = () => {
  ...
  const dropdowns = [
    ...
    },
    {
      ...
      items: [
        { name: "Collect Fees", path: "student-details" },
    ...
    },
    {
      ...
      title: "Academics",
      items: [
        { name: "Subjects", path: "student-details" },
  ...
  return (
    <div
      className={`
        ...
        -mt-[3px] h-full max-h-[35rem] overflow-y-auto
